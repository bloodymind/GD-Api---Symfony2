<?php
namespace Front\OfficeBundle\Services\GdApi;

use Front\OfficeBundle\Services\GdApi\thumb_plugins\GdReflectionLib as GdReflectionLib;
/**
...
abstract class ThumbBase 
{
	...
	protected function imports ($object)
	{
		...
		$new = array();
		if ( $object == "GdReflectionLib" ){
			$newImport = new GdReflectionLib();
		}
